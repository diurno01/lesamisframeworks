...
import com.lesamis.lesAmisSpring.services.UsuarioService2;
...
//    @GetMapping("/lista")
//    public ResponseEntity<List<UsuarioModel2>> obtenerUsuarios(){
//        List<UsuarioModel2> list = usuarioService.obtenerUsuarios();
//        return new ResponseEntity(list, HttpStatus.OK);
//    }

//    @GetMapping("/detalle/{id}")
//    public ResponseEntity<UsuarioModel2> obtenerUsuarioPorId(@PathVariable("id") Long id){
//        if(!usuarioService.existsById(id))
//            return new ResponseEntity(new MensajeModel("no existe"), HttpStatus.NOT_FOUND);
//        UsuarioModel2 usuario = usuarioService.obtenerUsuarioPorId(id).get();
//        return new ResponseEntity(usuario, HttpStatus.OK);
//    }

//    @GetMapping("/dni/{dni}")
//    public ResponseEntity<UsuarioModel2> obtenerUsuarioPorDni(@PathVariable("dni") Long dni){
//        if(!usuarioService.existsByDni(dni))
//            return new ResponseEntity(new MensajeModel("no existe"), HttpStatus.NOT_FOUND);
//        UsuarioModel2 usuario = usuarioService.obtenerPorDni(dni).get();
//        return new ResponseEntity(usuario, HttpStatus.OK);
//    }

//    @PostMapping("/crear")
//    public ResponseEntity<UsuarioModel2> create(@RequestBody UsuarioModel2 usuario){
...
//
//        UsuarioModel2 usuarioModel = new UsuarioModel2(usuario.getUsuario(),
//                usuario.getPassword(),
//                usuario.getDni(),
//                usuario.getNombre(),
//                usuario.getApellido(),
...
//    public ResponseEntity<UsuarioModel2> update(@PathVariable("id")Long id, @RequestBody UsuarioModel2 usuario){
//        if(!usuarioService.existsById(id))
//            return new ResponseEntity(new MensajeModel("no existe"), HttpStatus.NOT_FOUND);
...
//            return new ResponseEntity(new MensajeModel("Olvido competar el Tipo de usuario"), HttpStatus.BAD_REQUEST);
//
//        UsuarioModel2 usuarioModel = usuarioService.obtenerUsuarioPorId(id).get();
...
//    public ResponseEntity<UsuarioModel2> delete(@PathVariable("id")Long id){
//        if(!usuarioService.existsById(id))
//            return new ResponseEntity(new MensajeModel("no existe"), HttpStatus.NOT_FOUND);
